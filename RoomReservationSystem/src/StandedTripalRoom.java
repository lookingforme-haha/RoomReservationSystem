...
public class StandedTripalRoom extends Room implements SpecialServices {
	private double RampLength;
	private double RampWidth;
	private int NumOfEmergencyCalls;
	
	public StandedTripalRoom(String roomName, String description, String rType, String category, double rampLength, double rampWidth, int NumOfEmg, String specService) {
